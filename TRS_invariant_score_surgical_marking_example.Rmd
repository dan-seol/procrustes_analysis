...
transformed <- procGPAcompiled(samples_layered, reflect=FALSE)
TRS <- transformations(transformed$rotated, samples_layered)

TRSD["T"] <- TRS$translation
TRSD["R"] <- TRS$rotation
TRSD["S"] <- TRS$scale
TRSD["D"] <- transformed$rho
